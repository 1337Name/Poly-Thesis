...
def inject_into_icc(real_icc_path, payload):
    ...
    #dont change name as junk is somehow actually a valid tag name and it needs to be one of the set of valid ones
